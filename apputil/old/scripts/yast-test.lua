...
require("AppTools.YaST.Repository")
...
print("Retrieving information about http://download.opensuse.org/source/distribution/12.1/repo/oss/...")
repo = AppTools.YaST.Repository("http://download.opensuse.org/source/distribution/12.1/repo/oss/")
repo:PrintRepositoryInfo()
